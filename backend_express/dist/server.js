...
app.post('/api/orders', (req, res) => {
    ...
    db.run('INSERT INTO orders (id, customer_name, customer_email, customer_address, total_price) VALUES (?, ?, ?, ?, ?)', [orderId, customer_name, customer_email, customer_address, total_price], function (err) {
        if (err) {
        ...
        items.forEach((item) => {
            ...
            db.run('INSERT INTO order_items (id, order_id, product_id, quantity, price_at_purchase) VALUES (?, ?, ?, ?, ?)', [itemId, orderId, item.product_id, item.quantity, item.price], (_err) => {
                completed++;
